...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2022 at 02:20 AM
...
INSERT INTO `imunisasi` (`id`, `nama_vaksin`, `umur`) VALUES
(1, 'a', '14');
...
CREATE TABLE `jadwal_imunisasi` (
  ...
  `id_imunisasi` varchar(80) NOT NULL,
...
INSERT INTO `jadwal_imunisasi` (`id`, `tgl_imunisasi`, `id_posyandu`, `id_imunisasi`, `id_bidan`) VALUES
(2, '2022-07-23', '1', '1', 9);
...
(7, 'Aji Pratama', 'aji', 'ajip2606@gmail.com', '$2y$10$4i6lw1U/lkWm/.G6EWE4yO2hcuwSwyRlToBCTUdgyRx0QnQdOTuUq', 'lumajang', NULL, 'FOTO-(1).png', 0, NULL, NULL, 1, 'user'),
...
(10, 'Rendhy Pratama Putra', 'rendhy11', 'rendhy@gmail.com', '$2y$10$cBfVdMrg1OMWEKsWl9DAJu.AoDE0Co/bvxQ9o8pWHX89VV.IvfJvi', 'Kemuningsari Kidul, Jenggawah', NULL, 'foto_berwarna-compress1.jpg', 0, NULL, NULL, 0, 'user'),
...
(12, 'Deni Hidayatullah', 'Deni Hidayatullah', 'denih1360@gmail.com', '$2y$10$wImGOqqMUjPZYzdyd3Tre.4A5VpAwJDT3nxpwG5lDLpug8vFRMDJW', 'a', NULL, '1.jpg', NULL, '113.3864594', '-8.1274015', 1, 'user');
