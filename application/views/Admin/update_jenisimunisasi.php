            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit Jenis Imunisasi</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-gruop">
                                    <form action="<?php echo base_url('Admin/updateJenisImunisasiAction'); ?>"
                                        method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?= $jenisimunisasi->id?>">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" style="border-radius: 10px;" name="nama_vaksin"
                                                    ...
                                                    value="<?= $jenisimunisasi->nama_vaksin?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="fname"
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" style="border-radius: 10px;" name="umur"
                                                    ...
                                                    value="<?= $jenisimunisasi->umur?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
